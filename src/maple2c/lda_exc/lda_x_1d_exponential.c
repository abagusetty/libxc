...
func_exc_unpol(const xc_func_type *p, size_t ip, const double *rho, xc_lda_out_params *out)
{
  ...
  t12 = xc_integrate(func1_lda_x_1d_exponential, NULL, 1e-20, t11);
  t14 = xc_integrate(func2_lda_x_1d_exponential, NULL, 1e-20, t11);
  t16 = t14 / M_PI;
...
func_exc_pol(const xc_func_type *p, size_t ip, const double *rho, xc_lda_out_params *out)
{
  ...
  t16 = params->beta * t3;
  t17 = t15 * t16;
  t18 = xc_integrate(func1_lda_x_1d_exponential, NULL, 1e-20, t17);
  t20 = xc_integrate(func2_lda_x_1d_exponential, NULL, 1e-20, t17);
  t21 = 0.1e1 / M_PI;
  t22 = t20 * t21;
  ...
  t34 = t33 * M_PI;
  t35 = t34 * t16;
  t36 = xc_integrate(func1_lda_x_1d_exponential, NULL, 1e-20, t35);
  t38 = xc_integrate(func2_lda_x_1d_exponential, NULL, 1e-20, t35);
  t39 = t38 * t21;
